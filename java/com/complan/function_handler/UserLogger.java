...
public class UserLogger {
    ...
    public void get_executeCommands(Scanner scanner) {
        System.out.println("+--------------------------------------------------------------------------------+");
        System.out.println("|                          🔥️ " + BOLD + "WELCOME TO ComPlan" + RESET
                + " 🔥️                              |");
        System.out.println("+--------------------------------------------------------------------------------+");
        System.out.println();
        ...
        while (scanner.hasNextLine() == true) {
            ...
            try {
                if (command.equals("LOGIN")) {// LOGIN
                    ...
                    LocalDateTime dt = parseDate(date, time);
                    int response = Handler.askWMSlot(slotId, to_email, dt);
                    if (response == 0) {
                    ...
                    System.out.println(
                            "| * ASK_WMSLOT <slot ID> <to email-id> <date(dd-mm-yy)> <time(hh:mm)>                          |");
                    System.out.println("| * RESPOND_REQUEST <requestID> <accept(y/n)> " + BLUE
                            + "//types --> 1.VP Join Request, 2.give WMSlot" + RESET + "     |");
                    System.out.println(
                            "| * USE_WMSLOT <slot ID> <date(dd-mm-yy)> <time(hh:mm)> <otp>                                  |");
                    System.out.println(
                            "| * DISPLAY_WMSLOTS <date(dd-mm-yy)> <display only your slots(y/n)>                            |");
